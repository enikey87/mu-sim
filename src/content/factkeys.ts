...
import {
  ...
  bathAsked, mamaCalls, phoneKarine, alikDay, mooAt, sorryAt, rudeAt, thanksAt, topicRun, topicLast,
  ...
  lie, paydayScene, lightOff, netRation, phoneWarn, creditStage, creditOffer, creditBroke, momDone, creditDeclined,
} from './memkeys'
...
export type MemExactKey =
  ...
  | typeof bathAsked | typeof mamaCalls | typeof phoneKarine | typeof alikDay | typeof mooAt | typeof sorryAt
  ...
  | typeof creditStage | typeof creditOffer | typeof creditBroke | typeof momDone | typeof creditDeclined
