...
const ANY_STATE = new Set<string>([
  ...
  'Скажи, что «Нива» уехала. Проверено.', 'Можно я ему напишу, что я налоговая?', 'Алик, хватит на меня всё сваливать. Я даже не знаю, о чём речь.',
  'Брат, не верь ему про меня. Верь про других.', 'Алик, ты меня упомянул уже раз пять. Я требую долю.', 'Всё, я выхожу из этой истории. Разбирайтесь без меня.',
