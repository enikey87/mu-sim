...
export const NOTIF: Notif[] = [
  ...
  { icon: '🎸', app: 'Авито', t: 'Покупатель гитары пишет: «струна лопнула, как ваши нервы».', when: [is(sold('guitar'))] },
  { icon: '🧱', app: 'Алик', t: 'Плитку с объекта видел на Авито. Красивая была. Твоя была.', when: [is(sold('tile'))] },
  { icon: '🚗', app: 'Шиномонтаж', t: 'Зимнюю резину поставили на КамАЗ. Владелец спрашивает, где машина.', when: [is(sold('tires'))] },
