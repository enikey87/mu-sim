...
/** Три займа по порядку; четвёртая ступень — отказ платежа по микрозайму (`credit.broke`). {sum} в offer — сколько банк даст на деле (#337). */
export const LOANS: readonly Loan[] = [
  {
    ...
    offer: 'Вам одобрен кредит «Всё будет» — {sum} под 39,9%. Всё будет. Проценты — точно',
  },
  {
    id: 'refi', stage: 2, amount: 25000, payment: 20000, due: { week: true },
    label: 'Платёж по кредиту на погашение кредита',
    offer: 'Одобрен кредит на погашение кредита — {sum}. Мгновенно — мы вас уже знаем',
  },
  {
    id: 'micro', stage: 3, amount: 12000, payment: 16000, due: { week: true },
    label: 'Платёж МФО «Деньги-Ара»',
    offer: 'МФО «Деньги-Ара»: одобрено {sum}! Ваш поручитель — Алик? Прекрасно, он у нас уже есть',
  },
]
