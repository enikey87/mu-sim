...
export const ACH: Record<string, readonly [string, string | ((s: import("../engine/state").GameState) => string)]> = {
  ...
  amnesty: ['Амнистия', 'Обнулил просроченные обещания'],
  shaved: ['Без усов', 'Алик сбрил усы по ставке'],
  ...
  arc_beton: ['Клад', 'Узнал, где лежат твои деньги'],
  arc_rubik: ['Подозрительно ровно', 'Пережил проверку инспектора Рубика'],
  arc_razmik: ['Очередь по высоте', 'Досмотрел голодовку Размика на кране'],
  ...
  arc_collectors: ['Перевербовка', 'Коллекторы остались на объекте Алика'],
  ...
  // мини-квесты и суд
  q_hash: ['Хаш в счёт долга', 'Поел на часть своих денег'],
  q_niva: ['Толкач', 'Завёл «Ниву». Она уехала'],
  q_tamada: ['Тамада', 'Сказал 41 тост и разбил сервиз'],
  q_lottery: ['Джекпот', 'Выиграл чайник в лотерею Алика'],
  q_parking: ['Парковщик', 'Три часа держал место у банка'],
  q_mama: ['Хороший мальчик', 'Отвёз маму Алика на рынок'],
  q_crypto: ['Лаваш-коин', 'Вложился в армянскую крипту'],
  q_photo: ['Лицо бренда', 'Твоя плитка — в рекламе Алика'],
  q_witness: ['Свидетель', 'Дал показания в налоговой'],
  q_goat: ['Спасатель', 'Снимал козу с крыши'],
