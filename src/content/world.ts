...
export const CHORUS: Record<string, Entry<string>[]> = {
  garik: [needs('garikFree')('Я вообще-то рядом стою. Алик, скажи ему правду.'), 'Алик, хватит на меня всё сваливать. Я даже не знаю, о чём речь.', needs('garikFree')('Привет. Я ничего не брал. Если что — я на свадьбе.'), 'Брат, не верь ему про меня. Верь про других.'],
  ...
  nune: [needs('dekret')('Я в декрете, но всё слышу. Денег нет.'), needs('dekret')('Не упоминайте меня, у меня ребёнок спит.'), 'По бумагам вы Алику должны. Шучу. Или нет.'],
